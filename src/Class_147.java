...
final class Class_147 extends Class_1ac {
   ...
   public final void sub_42d(boolean var1) {
      ...
      label76: {
         ...
         var2 = Class_ec.sub_abc(8192L, var4);
         var3 = Class_ec.sub_acf(8192L, var4);
         if (var1) {
            var10000 = this;
            var10001 = var2;
         } else {
            if ((var8 = Class_ec.sub_9f9(this.var_2c4 - var2 >> 2)) > 1536) {
               var8 = 1536;
            }
      ...
      label68: {
         if (var1) {
            ...
            if ((var8 = Class_ec.sub_9f9(this.var_2ed - var3 >> 2)) > 1536) {
               var8 = 1536;
            }
